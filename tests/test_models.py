...
class TestShopcart(unittest.TestCase):
    ...
    def test_update_a_shopcart(self):
        """Update a Shopcart"""
        shopcart = Shopcart(customer_id=123, product_id=231, product_name="a",product_price=23.1,quantity=1)
    ...
    def test_deserialize_shopcart(self):
        ...
        self.assertEqual(shopcart.customer_name, "abc")
        self.assertEqual(shopcart.customer_price, 1234)
